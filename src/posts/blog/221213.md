...
category: "Next"
date: "2022-12-13 12:00:00 +09:00"
desc: "Next.js, Prisma, PlanetScale을 통해 초기 개발 환경 구축, Axios로 간단한 get, post 테스트" 
thumbnail: "./images/thumbnail/next.png"
alt: "11"
---
...
![pscale1](./images/221213/pscale1.png)
![pscale2](./images/221213/pscale2.png)
...
![addpost](./images/221213/addpost.png)

Add Post를 누르면 보내려 한 내용이 잘 반영이 되는 것을 볼 수 있다.

## Prisma Studio

Prisma는 데이터베이스의 GUI Tool을 제공한다. `npx prisma studio`를 사용하여 `localhost:5555`에서 작성한 model을 확인할 수 있다.

![prismastudio](./images/221213/prismastudio.png)
