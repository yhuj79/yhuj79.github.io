...
date: "2022-09-22 12:00:00 +09:00"
desc: "선형(Linear) 자료 구조 'Stack', 'Queue' 살펴보기"
thumbnail: "./images/thumbnail/datastructure.png"
alt: "2"
---

## 선형 구조 & 비선형 구조

자료구조의 종류에는 선형 구조와 비선형 구조가 있다.
- 선형 구조(linear) : 데이터가 1:1의 관계를 가짐.
  - ex ) Stack, Queue, Linked List, Deque
- 비선형 구조(Nonlinear) : 데이터가 1:n 또는 n:n 관계를 가짐.
  - ex ) Tree, Graph

이 중 선형 구조에 해당하는 Stack과 Queue를 javascript로 간단하게 구현해 보았다.

## Stack

![stack1](./images/220922/stack1.png)
...
push와 pop을 사용하여 javascript로 쉽게 구현할 수 있는데
...
![stack2](./images/220922/stack2.png)
...
![queue1](./images/220922/queue1.png)
...
![queue2](./images/220922/queue2.png)
...
[https://booksr.co.kr/html/book/book.asp?seq=697058](https://booksr.co.kr/html/book/book.asp?seq=697058)
