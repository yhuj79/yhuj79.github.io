...
desc: "자바스크립트에서 구조 분해 할당은 객체 또는 배열의 속성을 분해하고 개별 변수를 쉽고 편리하게 할당하여 사용할 수 있게 해준다."
...
```javascript
let arr = 
    ["apple", "banana", "tomato", "pear", "grapes", "mango"]
...
![jsonplaceholder](./images/220928/jsonplaceholder.png)
...
![objectEntries](./images/220928/objectEntries.png)
