...
title: "구조 분해 할당"
category: "JavaScript"
date: "2022-09-28 12:00:00 +09:00"
desc: "JavaScript Destructuring Assignment"
...
// let four = arr[3]
// let five = arr[4]
// let six = arr[5]      // 배열의 값을 각각 저장

let [one, two, three, four, five, six] = arr; // 위 코드와 동일하게 동작함
...
let { name: a, job: b, age: c } = user; // 각각 name을 a, job을 b, age를 c로 저장
...
let [one, two, three, ...other] = arr; // four ~ six는 other에 저장됨
let { name: a, ...rest } = user;

console.log(`${one}, ${two}, ${three}`) // apple, banana, tomato
console.log(`나머지 : ${other}`) // 나머지 : pear,grapes,mango
console.log(`job: ${rest.job}, age: ${rest.age}`) // job: developer, age: 28
```
...
![jsonplaceholder](../../../images/2022-09-28-4/jsonplaceholder.png)
...
![objectEntries](../../../images/2022-09-28-4/objectEntries.png)
