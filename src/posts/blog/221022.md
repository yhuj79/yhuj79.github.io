...
category: "Jest"
date: "2022-10-22 12:00:00 +09:00"
...
**Jest**는 React를 만든 Facebook에서 개발한 테스팅 프레임워크(Testing Framework)이다. Babel, TypeScript, Node, React, Angular, Vue 등을 사용하는 프로젝트에서 작동하며, 테스트 코드의 모양이 직관적이고 문서화가 잘 이루어져 있어 많이 활용되고 있다.
...
```javascript
const funcAdd = { // 두 개의 인수를 받아 그 합을 리턴
