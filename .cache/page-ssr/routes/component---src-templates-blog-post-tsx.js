...
const Comment = () => {
  var _site$utterances;

  const site = (0,Hooks_useSiteMetadata__WEBPACK_IMPORTED_MODULE_2__["default"])();
  const {
    repo
  } = (_site$utterances = site.utterances) !== null && _site$utterances !== void 0 ? _site$utterances : {
    repo: undefined
  };
  ...
  const isUtterancesCreated = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(false);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (!isUtterancesCreated.current) {
      themeMode = document.body.dataset.theme === Constants_theme__WEBPACK_IMPORTED_MODULE_3__.DARK ? DARK_THEME : LIGHT_THEME;
    } else themeMode = theme === Constants_theme__WEBPACK_IMPORTED_MODULE_3__.DARK ? DARK_THEME : LIGHT_THEME;
    ...
    const createUtterancesEl = () => {
      ...
      (_containerRef$current = containerRef.current) === null || _containerRef$current === void 0 ? void 0 : _containerRef$current.appendChild(comment);
      isUtterancesCreated.current = true;
    };

    const utterancesEl = (_containerRef$current2 = containerRef.current) === null || _containerRef$current2 === void 0 ? void 0 : _containerRef$current2.querySelector(utterancesSelector);

    const postThemeMessage = () => {
      var _utterancesEl$content;
      ...
      utterancesEl === null || utterancesEl === void 0 ? void 0 : (_utterancesEl$content = utterancesEl.contentWindow) === null || _utterancesEl$content === void 0 ? void 0 : _utterancesEl$content.postMessage(message, src);
    };
...
/* harmony import */ var Components_comment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! Components/comment */ "./src/components/comment.tsx");
/* harmony import */ var Styles_typography__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! Styles/typography */ "./src/styles/typography.ts");
/* harmony import */ var Styles_category__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! Styles/category */ "./src/styles/category.ts");
/* harmony import */ var Styles_dateTime__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! Styles/dateTime */ "./src/styles/dateTime.ts");
/* harmony import */ var Styles_markdown__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! Styles/markdown */ "./src/styles/markdown.ts");
...
const BlogPost = ({
  ...
  var _thumbnail$childImage, _thumbnail$childImage2;
  ...
  const ogImagePath = thumbnail && (thumbnail === null || thumbnail === void 0 ? void 0 : (_thumbnail$childImage = thumbnail.childImageSharp) === null || _thumbnail$childImage === void 0 ? void 0 : (_thumbnail$childImage2 = _thumbnail$childImage.gatsbyImageData) === null || _thumbnail$childImage2 === void 0 ? void 0 : _thumbnail$childImage2.src);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Layouts_layout__WEBPACK_IMPORTED_MODULE_1__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Components_seo__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    desc: desc,
    image: ogImagePath
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("article", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(OuterWrapper, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(InnerWrapper, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("header", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Info, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PostCategory, null, category), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Time, {
    dateTime: date
  }, date)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Title, null, title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Desc, null, desc)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Divider, null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Styles_markdown__WEBPACK_IMPORTED_MODULE_7__["default"], {
    dangerouslySetInnerHTML: {
      __html: html !== null && html !== void 0 ? html : ""
    },
    rhythm: Styles_typography__WEBPACK_IMPORTED_MODULE_4__.rhythm
  }))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(CommentWrap, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Components_comment__WEBPACK_IMPORTED_MODULE_3__["default"], null))));
};

const OuterWrapper = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({
  displayName: "blogPost__OuterWrapper"
})(["margin-top:var(--sizing-xl);@media (max-width:", "){margin-top:var(--sizing-lg);}"], ({
  theme
}) => theme.device.sm);
const InnerWrapper = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({
  displayName: "blogPost__InnerWrapper"
})(["width:var(--post-width);margin:0 auto;padding-bottom:var(--sizing-lg);@media (max-width:", "){width:87.5%;}"], ({
  theme
}) => theme.device.sm);
const CommentWrap = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].section.withConfig({
  displayName: "blogPost__CommentWrap"
})(["width:100%;padding:0 var(--padding-sm);margin:0 auto;margin-bottom:var(--sizing-xl);@media (max-width:", "){width:auto;}"], ({
  theme
}) => theme.device.sm);
const PostCategory = (0,styled_components__WEBPACK_IMPORTED_MODULE_8__["default"])(Styles_category__WEBPACK_IMPORTED_MODULE_5__["default"]).withConfig({
  displayName: "blogPost__PostCategory"
})(["font-size:0.875rem;font-weight:var(--font-weight-semi-bold);"]);
const Info = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({
  displayName: "blogPost__Info"
})(["margin-bottom:var(--sizing-md);"]);
const Time = (0,styled_components__WEBPACK_IMPORTED_MODULE_8__["default"])(Styles_dateTime__WEBPACK_IMPORTED_MODULE_6__["default"]).withConfig({
  displayName: "blogPost__Time"
})(["display:block;margin-top:var(--sizing-xs);"]);
const Desc = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].p.withConfig({
  displayName: "blogPost__Desc"
})(["margin-top:var(--sizing-lg);line-height:1.5;font-size:var(--text-lg);@media (max-width:", "){line-height:1.31579;font-size:1.1875rem;}"], ({
  theme
}) => theme.device.sm);
const Divider = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({
  displayName: "blogPost__Divider"
})(["width:100%;height:1px;background-color:var(--color-gray-3);margin-top:var(--sizing-lg);margin-bottom:var(--sizing-lg);"]);
const Title = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].h1.withConfig({
  displayName: "blogPost__Title"
})(["font-weight:var(--font-weight-bold);line-height:1.1875;font-size:var(--text-xl);@media (max-width:", "){line-height:1.21875;font-size:2.5rem;}@media (max-width:", "){line-height:1.21875;font-size:2rem;}"], ({
  theme
}) => theme.device.md, ({
  theme
}) => theme.device.sm);
const query = "1786805275";
